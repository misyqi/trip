<template>
        ...
        <el-table :data="tableData" stripe style="width: 100%" v-loading="loading">
            <el-table-column  label="商品" width="300">
                <template #default="{row}">
                    <div class="flex">
                        <el-image class="mr-3 rounded" :src="row.cover" fit="cover" :lazy="true" style="width: 50ox;height: 50px;"></el-image>
                        <div class="flex-1">
                            <p>{{ row.title }}</p>
                            <div>
                            ...
                            <p class="text-gray-400 text-xs mb-1">分类:{{ row.category?row.category.name:"为分类" }}</p>
    ...
    <banner ref="bannersRef" @reload-data="getData"/>
